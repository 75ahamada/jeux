...
let questions = [
  new Question("Quelle est le nom d'une fille le plus beau dans le monde ?", ["RACHIDAT", "FARDAT", "ASMINA", "FAOUZA"], "RACHIDAT"),
  new Question("Parmis les 4garcons quel est que ", ["isNaN()","includes()", "findIndex()", "isOdd()"], "includes()"),
